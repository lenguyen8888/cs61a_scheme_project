...
def do_define_form(expressions, env):
    ...
    if scheme_symbolp(signature):
        ...
        # BEGIN PROBLEM 10
        "*** YOUR CODE HERE ***"
        # create a lambda procedure from do_lambda_form
        lambda_procedure = do_lambda_form(Pair(signature.rest, expressions.rest), env)
        # define the symbol to have the value of the lambda procedure
...
def do_lambda_form(expressions, env):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    # create a lambda procedure and return it
...
def do_and_form(expressions, env):
    ...
    while expressions is not nil:
        ...
        # check result by is_scheme_false
...
def do_or_form(expressions, env):
    ...
    while expressions is not nil:
        # calculate the result
        result = scheme_eval(expressions.first, env)
        # check result by is_scheme_true
...
def do_cond_form(expressions, env):
    ...
    while expressions is not nil:
        ...
        if is_scheme_true(test):
            # BEGIN PROBLEM 13
            "*** YOUR CODE HERE ***"
            # if there's no expression after the test return the test
